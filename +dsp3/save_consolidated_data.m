...
trial_data_cont = dsp2.process.format.fix_block_number( trial_data_cont );
trial_data_cont = dsp2.process.format.fix_administration( trial_data_cont );
...
event_data_cont = Container( reshaped_events, trial_data_cont.labels );
