function results = save_summarized_psd(event_name, varargin)

defaults = dsp3.make.defaults.summarized_psd();

inputs = { fullfile('original_per_trial_psd', event_name) };
output = fullfile( 'original_summarized_psd', event_name );
