function [anatomy, anatomy_labels, column_key] = dsp3_get_unit_anatomy_info(conf)
...
[anatomy, anatomy_labels, column_key] = dsp3_anatomy_xls_to_data_and_labels( xls_raw );
